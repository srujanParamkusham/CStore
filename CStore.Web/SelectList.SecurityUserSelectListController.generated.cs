...
{
    public partial class SecurityUserSelectListController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected SecurityUserSelectListController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public SecurityUserSelectListController Actions { get { return MVC.SelectList.SecurityUserSelectList; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "SelectList";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "SecurityUserSelectList";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "SecurityUserSelectList";
        [GeneratedCode("T4MVC", "2.0")]
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_SecurityUserSelectListController : CStore.Web.Areas.SelectList.Controllers.SecurityUserSelectListController
    {
        public T4MVC_SecurityUserSelectListController() : base(Dummy.Instance) { }

        [NonAction]
        partial void ListOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, CStore.Domain.Domains.SelectList.Models.ViewModels.SecurityUserSelectList.SecurityUserSelectListViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult List(CStore.Domain.Domains.SelectList.Models.ViewModels.SecurityUserSelectList.SecurityUserSelectListViewModel model)
        {
