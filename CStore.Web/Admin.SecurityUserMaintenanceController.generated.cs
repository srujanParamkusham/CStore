...
{
    public partial class SecurityUserMaintenanceController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected SecurityUserMaintenanceController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public SecurityUserMaintenanceController Actions { get { return MVC.Admin.SecurityUserMaintenance; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "SecurityUserMaintenance";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "SecurityUserMaintenance";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Edit = "~/Areas/Admin/Views/SecurityUserMaintenance/Edit.cshtml";
            public readonly string Index = "~/Areas/Admin/Views/SecurityUserMaintenance/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_SecurityUserMaintenanceController : CStore.Web.Areas.Admin.Controllers.SecurityUserMaintenanceController
    {
        public T4MVC_SecurityUserMaintenanceController() : base(Dummy.Instance) { }

        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, CStore.Domain.Domains.Admin.Models.ViewModels.SecurityUserMaintenance.SecurityUserMaintenanceListViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(CStore.Domain.Domains.Admin.Models.ViewModels.SecurityUserMaintenance.SecurityUserMaintenanceListViewModel model)
        {
        ...
        [NonAction]
        partial void ListOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, CStore.Domain.Domains.Admin.Models.ViewModels.SecurityUserMaintenance.SecurityUserMaintenanceListViewModel model, Catalyst.MVC.Infrastructure.Models.JQueryDataTables.JQueryDataTablesParameterModel dataTablesModel);

        [NonAction]
        public override System.Web.Mvc.ActionResult List(CStore.Domain.Domains.Admin.Models.ViewModels.SecurityUserMaintenance.SecurityUserMaintenanceListViewModel model, Catalyst.MVC.Infrastructure.Models.JQueryDataTables.JQueryDataTablesParameterModel dataTablesModel)
        {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int? id, CStore.Domain.Domains.Admin.Models.ViewModels.SecurityUserMaintenance.SecurityUserMaintenanceEditViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(int? id, CStore.Domain.Domains.Admin.Models.ViewModels.SecurityUserMaintenance.SecurityUserMaintenanceEditViewModel model)
        {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, CStore.Domain.Domains.Admin.Models.ViewModels.SecurityUserMaintenance.SecurityUserMaintenanceEditViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(CStore.Domain.Domains.Admin.Models.ViewModels.SecurityUserMaintenance.SecurityUserMaintenanceEditViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
