...
{
    public partial class SecurityRoleMaintenanceController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected SecurityRoleMaintenanceController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public SecurityRoleMaintenanceController Actions { get { return MVC.Admin.SecurityRoleMaintenance; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "SecurityRoleMaintenance";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "SecurityRoleMaintenance";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Edit = "~/Areas/Admin/Views/SecurityRoleMaintenance/Edit.cshtml";
            public readonly string Index = "~/Areas/Admin/Views/SecurityRoleMaintenance/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_SecurityRoleMaintenanceController : CStore.Web.Areas.Admin.Controllers.SecurityRoleMaintenanceController
    {
        public T4MVC_SecurityRoleMaintenanceController() : base(Dummy.Instance) { }

        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, CStore.Domain.Domains.Admin.Models.ViewModels.SecurityRoleMaintenance.SecurityRoleMaintenanceListViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(CStore.Domain.Domains.Admin.Models.ViewModels.SecurityRoleMaintenance.SecurityRoleMaintenanceListViewModel model)
        {
        ...
        [NonAction]
        partial void ListOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, CStore.Domain.Domains.Admin.Models.ViewModels.SecurityRoleMaintenance.SecurityRoleMaintenanceListViewModel model, Catalyst.MVC.Infrastructure.Models.JQueryDataTables.JQueryDataTablesParameterModel dataTablesModel);

        [NonAction]
        public override System.Web.Mvc.ActionResult List(CStore.Domain.Domains.Admin.Models.ViewModels.SecurityRoleMaintenance.SecurityRoleMaintenanceListViewModel model, Catalyst.MVC.Infrastructure.Models.JQueryDataTables.JQueryDataTablesParameterModel dataTablesModel)
        {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int? id, CStore.Domain.Domains.Admin.Models.ViewModels.SecurityRoleMaintenance.SecurityRoleMaintenanceEditViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(int? id, CStore.Domain.Domains.Admin.Models.ViewModels.SecurityRoleMaintenance.SecurityRoleMaintenanceEditViewModel model)
        {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, CStore.Domain.Domains.Admin.Models.ViewModels.SecurityRoleMaintenance.SecurityRoleMaintenanceEditViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(CStore.Domain.Domains.Admin.Models.ViewModels.SecurityRoleMaintenance.SecurityRoleMaintenanceEditViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
