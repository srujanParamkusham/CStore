...
{
    public partial class PasswordHashGeneratorController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected PasswordHashGeneratorController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public PasswordHashGeneratorController Actions { get { return MVC.Admin.PasswordHashGenerator; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "PasswordHashGenerator";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "PasswordHashGenerator";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            {
                public readonly string _PasswordHashForm = "_PasswordHashForm";
                public readonly string Index = "Index";
            }
            public readonly string _PasswordHashForm = "~/Areas/Admin/Views/PasswordHashGenerator/_PasswordHashForm.cshtml";
            public readonly string Index = "~/Areas/Admin/Views/PasswordHashGenerator/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_PasswordHashGeneratorController : CStore.Web.Areas.Admin.Controllers.PasswordHashGeneratorController
    {
        public T4MVC_PasswordHashGeneratorController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, CStore.Domain.Domains.Admin.Models.ViewModels.PasswordHashGenerator.PasswordHashGeneratorViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(CStore.Domain.Domains.Admin.Models.ViewModels.PasswordHashGenerator.PasswordHashGeneratorViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
