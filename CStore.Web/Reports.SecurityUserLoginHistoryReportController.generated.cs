...
{
    public partial class SecurityUserLoginHistoryReportController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected SecurityUserLoginHistoryReportController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public SecurityUserLoginHistoryReportController Actions { get { return MVC.Reports.SecurityUserLoginHistoryReport; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Reports";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "SecurityUserLoginHistoryReport";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "SecurityUserLoginHistoryReport";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Areas/Reports/Views/SecurityUserLoginHistoryReport/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_SecurityUserLoginHistoryReportController : CStore.Web.Areas.Reports.Controllers.SecurityUserLoginHistoryReportController
    {
        public T4MVC_SecurityUserLoginHistoryReportController() : base(Dummy.Instance) { }

        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, CStore.Domain.Domains.Reports.Models.ViewModels.SecurityUserLoginHistoryReport.SecurityUserLoginHistoryReportParamsViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(CStore.Domain.Domains.Reports.Models.ViewModels.SecurityUserLoginHistoryReport.SecurityUserLoginHistoryReportParamsViewModel model)
        {
