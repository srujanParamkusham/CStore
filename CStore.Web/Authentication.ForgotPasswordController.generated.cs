...
namespace CStore.Web.Areas.Authentication.Controllers
{
    public partial class ForgotPasswordController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ForgotPasswordController Actions { get { return MVC.Authentication.ForgotPassword; } }
        ...
        public class ViewsClass
        {
            ...
            {
                public readonly string ForgotPasswordSuccessfullyRequested = "ForgotPasswordSuccessfullyRequested";
                public readonly string Index = "Index";
                public readonly string PasswordSuccessfullyReset = "PasswordSuccessfullyReset";
                public readonly string Reset = "Reset";
            }
            public readonly string ForgotPasswordSuccessfullyRequested = "~/Areas/Authentication/Views/ForgotPassword/ForgotPasswordSuccessfullyRequested.cshtml";
            public readonly string Index = "~/Areas/Authentication/Views/ForgotPassword/Index.cshtml";
            public readonly string PasswordSuccessfullyReset = "~/Areas/Authentication/Views/ForgotPassword/PasswordSuccessfullyReset.cshtml";
            public readonly string Reset = "~/Areas/Authentication/Views/ForgotPassword/Reset.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ForgotPasswordController : CStore.Web.Areas.Authentication.Controllers.ForgotPasswordController
    {
        ...
        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, CStore.Domain.Domains.Authentication.Models.ViewModels.ForgotPassword.ForgotPasswordViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(CStore.Domain.Domains.Authentication.Models.ViewModels.ForgotPassword.ForgotPasswordViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
        ...
        [NonAction]
        partial void ResetOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string id, string t);

        [NonAction]
        public override System.Web.Mvc.ActionResult Reset(string id, string t)
        {
            ...
            ResetOverride(callInfo, id, t);
            return callInfo;
        }

        [NonAction]
        partial void ResetOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, CStore.Domain.Domains.Authentication.Models.ViewModels.ForgotPassword.ResetForgottenPasswordViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Reset(CStore.Domain.Domains.Authentication.Models.ViewModels.ForgotPassword.ResetForgottenPasswordViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Reset);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
