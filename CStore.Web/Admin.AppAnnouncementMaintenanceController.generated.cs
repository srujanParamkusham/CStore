...
{
    public partial class AppAnnouncementMaintenanceController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected AppAnnouncementMaintenanceController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public AppAnnouncementMaintenanceController Actions { get { return MVC.Admin.AppAnnouncementMaintenance; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "AppAnnouncementMaintenance";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "AppAnnouncementMaintenance";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Edit = "~/Areas/Admin/Views/AppAnnouncementMaintenance/Edit.cshtml";
            public readonly string Index = "~/Areas/Admin/Views/AppAnnouncementMaintenance/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AppAnnouncementMaintenanceController : CStore.Web.Areas.Admin.Controllers.AppAnnouncementMaintenanceController
    {
        public T4MVC_AppAnnouncementMaintenanceController() : base(Dummy.Instance) { }

        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, CStore.Domain.Domains.Admin.Models.ViewModels.AppAnnouncementMaintenance.AppAnnouncementMaintenanceListViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(CStore.Domain.Domains.Admin.Models.ViewModels.AppAnnouncementMaintenance.AppAnnouncementMaintenanceListViewModel model)
        {
        ...
        [NonAction]
        partial void ListOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, CStore.Domain.Domains.Admin.Models.ViewModels.AppAnnouncementMaintenance.AppAnnouncementMaintenanceListViewModel model, Catalyst.MVC.Infrastructure.Models.JQueryDataTables.JQueryDataTablesParameterModel dataTablesModel);

        [NonAction]
        public override System.Web.Mvc.ActionResult List(CStore.Domain.Domains.Admin.Models.ViewModels.AppAnnouncementMaintenance.AppAnnouncementMaintenanceListViewModel model, Catalyst.MVC.Infrastructure.Models.JQueryDataTables.JQueryDataTablesParameterModel dataTablesModel)
        {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int? id, CStore.Domain.Domains.Admin.Models.ViewModels.AppAnnouncementMaintenance.AppAnnouncementMaintenanceEditViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(int? id, CStore.Domain.Domains.Admin.Models.ViewModels.AppAnnouncementMaintenance.AppAnnouncementMaintenanceEditViewModel model)
        {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, CStore.Domain.Domains.Admin.Models.ViewModels.AppAnnouncementMaintenance.AppAnnouncementMaintenanceEditViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(CStore.Domain.Domains.Admin.Models.ViewModels.AppAnnouncementMaintenance.AppAnnouncementMaintenanceEditViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
