...
namespace CStore.Web.Areas.Example.Controllers
{
    public partial class ExampleController
    {
        ...
        protected ExampleController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ExampleController Actions { get { return MVC.Example.Example; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Example";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Example";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Example";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Areas/Example/Views/Example/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ExampleController : CStore.Web.Areas.Example.Controllers.ExampleController
    {
        public T4MVC_ExampleController() : base(Dummy.Instance) { }
