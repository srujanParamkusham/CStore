...
{
    public partial class AESKeyGeneratorController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected AESKeyGeneratorController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public AESKeyGeneratorController Actions { get { return MVC.Admin.AESKeyGenerator; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "AESKeyGenerator";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "AESKeyGenerator";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            {
                public readonly string _AESKeyForm = "_AESKeyForm";
                public readonly string Index = "Index";
            }
            public readonly string _AESKeyForm = "~/Areas/Admin/Views/AESKeyGenerator/_AESKeyForm.cshtml";
            public readonly string Index = "~/Areas/Admin/Views/AESKeyGenerator/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AESKeyGeneratorController : CStore.Web.Areas.Admin.Controllers.AESKeyGeneratorController
    {
        public T4MVC_AESKeyGeneratorController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, CStore.Domain.Domains.Admin.Models.ViewModels.AESKeyGenerator.AESKeyGeneratorViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(CStore.Domain.Domains.Admin.Models.ViewModels.AESKeyGenerator.AESKeyGeneratorViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
