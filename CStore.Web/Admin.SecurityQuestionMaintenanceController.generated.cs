...
{
    public partial class SecurityQuestionMaintenanceController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected SecurityQuestionMaintenanceController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public SecurityQuestionMaintenanceController Actions { get { return MVC.Admin.SecurityQuestionMaintenance; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "SecurityQuestionMaintenance";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "SecurityQuestionMaintenance";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Edit = "~/Areas/Admin/Views/SecurityQuestionMaintenance/Edit.cshtml";
            public readonly string Index = "~/Areas/Admin/Views/SecurityQuestionMaintenance/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_SecurityQuestionMaintenanceController : CStore.Web.Areas.Admin.Controllers.SecurityQuestionMaintenanceController
    {
        public T4MVC_SecurityQuestionMaintenanceController() : base(Dummy.Instance) { }

        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, CStore.Domain.Domains.Admin.Models.ViewModels.SecurityQuestionMaintenance.SecurityQuestionMaintenanceListViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(CStore.Domain.Domains.Admin.Models.ViewModels.SecurityQuestionMaintenance.SecurityQuestionMaintenanceListViewModel model)
        {
        ...
        [NonAction]
        partial void ListOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, CStore.Domain.Domains.Admin.Models.ViewModels.SecurityQuestionMaintenance.SecurityQuestionMaintenanceListViewModel model, Catalyst.MVC.Infrastructure.Models.JQueryDataTables.JQueryDataTablesParameterModel dataTablesModel);

        [NonAction]
        public override System.Web.Mvc.ActionResult List(CStore.Domain.Domains.Admin.Models.ViewModels.SecurityQuestionMaintenance.SecurityQuestionMaintenanceListViewModel model, Catalyst.MVC.Infrastructure.Models.JQueryDataTables.JQueryDataTablesParameterModel dataTablesModel)
        {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int? id, CStore.Domain.Domains.Admin.Models.ViewModels.SecurityQuestionMaintenance.SecurityQuestionMaintenanceEditViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(int? id, CStore.Domain.Domains.Admin.Models.ViewModels.SecurityQuestionMaintenance.SecurityQuestionMaintenanceEditViewModel model)
        {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, CStore.Domain.Domains.Admin.Models.ViewModels.SecurityQuestionMaintenance.SecurityQuestionMaintenanceEditViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(CStore.Domain.Domains.Admin.Models.ViewModels.SecurityQuestionMaintenance.SecurityQuestionMaintenanceEditViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
